<div class="container-fluid">
    ...
    <hr>
    <br>
    <form method="POST" action="<?php echo site_url('Home/proses_edit_kegiatan'); ?>">
    <input type="hidden" name="id" value="<?php echo $himpunan['id_himpunan'] ?>">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="nama_kegiatan" class="form-control" id="nama_kegiatan" name="nama_kegiatan" value="<?php echo $himpunan['nama'];  ?>">
        </div>
        <div class="mb-3">
